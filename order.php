    ...
    <section class="food-search">
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <?php
                          //check wheteher image is available or not
                          if($image_name=="")
                          {
                            //image not available
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Sahana" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 9843xxxxxx" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="E.g. hi@sahana.com" class="input-responsive" required>
            ...
            if(isset($_POST['submit']))
            {
                ...
                $status="ordered";//ordered ,on delivery,delivered,concelled
